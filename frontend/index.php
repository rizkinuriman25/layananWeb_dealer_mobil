...
<div class="mobil-container">
    <?php while ($mobil = mysqli_fetch_assoc($result_mobil)): ?>
        <div class="mobil-card">
            ...
            <h4><?= htmlspecialchars($mobil['merk']) ?>     <?= htmlspecialchars($mobil['model']) ?> (<?= $mobil['tahun'] ?>)
            </h4>
...
<style>
    ...
    .mobil-card {
        ...
        text-align: center;
        width: 250px;
        /* Lebih lebar untuk tampilan landscape */
    ...
    .mobil-card img {
        ...
        height: 150px;
        /* Atur tinggi agar tetap landscape */
        object-fit: cover;
        /* Pastikan gambar tetap proporsional */
        object-position: center;
        /* Fokuskan pada bagian tengah */
