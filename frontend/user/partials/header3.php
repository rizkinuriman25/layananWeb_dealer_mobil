...
<body>
    ...
    <header>
        ...
        <nav>
            <a href="<?= $base_path ?>/dashboard.php"><i class="bi bi-speedometer2"></i>Dashboard</a> |
            <a href="<?= $base_path ?>/profil.php"><i class="bi bi-person-circle"></i>Profil</a> |
            <a href="<?= $base_path ?>/mobil/list.php"><i class="bi bi-car-front"></i>Cari Mobil</a> |
            <a href="<?= $base_path ?>/pembelian/riwayat.php"><i class="bi bi-bag-check"></i>Riwayat Pembelian</a> |
            <div class="dropdown">
                <a href="javascript:void(0)"><i class="bi bi-wrench-adjustable-circle"></i>Riwayat Layanan</a>
                <div class="dropdown-content">
                    <a href="<?= $base_path ?>/layanan/form_layanan.php">Form Layanan</a>
                    <a href="<?= $base_path ?>/layanan/riwayat_layanan.php">Riwayat Layanan</a>
                </div>
            </div> |
